...
module.exports = function appStoreIcon (style) {
  ...
  // On Android 4.2-, both height and width must be explicitly set for the SVG to show
  ...
  return svg('svg', options, [
    svg('g', [
      svg('path', {fill: '#010101', d: 'M391.335,417.674 c0,5.119-3.761,8.301-8.875,8.301H232.105c-5.116,0-9.266-4.151-9.266-9.271v-39.159c0-5.118,4.149-9.268,9.266-9.268H382.46 c5.114,0,8.875,4.15,8.875,9.268V417.674z'}),
      svg('g', [
        svg('g', [
